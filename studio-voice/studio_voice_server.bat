...
echo.
echo Usage:
echo   studio_voice_server.bat          - Start the container
echo   studio_voice_server.bat --test   - Test if server is running
echo   studio_voice_server.bat --stop   - Stop the container
echo   studio_voice_server.bat --status - Check container status
echo.
...
if errorlevel 1 (
    ...
    echo.
    echo To test the server, run: studio_voice_server.bat --test
    echo.
    pause
)
