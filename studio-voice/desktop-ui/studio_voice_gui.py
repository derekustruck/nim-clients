#!/usr/bin/env python3
"""
Studio Voice Desktop UI
A tkinter-based desktop interface for the Studio Voice NIM client
"""
...
class StudioVoiceDesktopApp:
    ...
    def setup_ui(self):
        ...
        process_frame.grid(row=3, column=0, columnspan=3, sticky=(tk.W, tk.E, tk.N, tk.S), pady=(0, 10))
    ...
    def process_files(self):
        ...
        for i, input_file in enumerate(self.selected_files):
            ...
            try:
                ...
                result = self.process_single_file(input_file, None)
